...
$joueur1 = new Player ("Kylian","Mbappé","20.12.1998",$nationality1); // PSG,AS Monaco
$joueur2 = new Player("Dimitri","Payet","29.03.1987",$nationality1); //OM, West Ham United
$joueur3 = new Player("Pedro","Ruiz","30.03.2000",$nationality2); //OM, Real Madrid
$joueur4 = new Player("Sergio","Ramos","30.03.1986",$nationality2); //PSG, Real Madrid


echo $joueur1->getPlayer();
echo $joueur2->getPlayer();
echo $joueur3->getPlayer();
echo $joueur4->getPlayer();

echo $nationality1-> displayNationality();
echo $nationality2-> displayNationality();
